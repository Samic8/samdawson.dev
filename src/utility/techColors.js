export const techToBgColor = {
  ...
  Typescript: "bg-blue-200 text-blue-900 dark:bg-blue-900 dark:text-slate-300",
  Javascript: "bg-blue-300 text-blue-900 dark:bg-blue-900 dark:text-slate-300",
  Productivity: "bg-red-200 text-red-900 dark:bg-red-900 dark:text-slate-300",
  Testing: "bg-yellow-300 text-yellow-900 dark:bg-yellow-900 dark:text-slate-300",
  GraphQL: "bg-pink-300 text-pink-900 dark:bg-pink-900 dark:text-slate-300",
}
